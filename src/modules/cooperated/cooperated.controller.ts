import { Controller, Get, Post, Body, Patch, Param, Query, Delete, UseGuards, ParseIntPipe, DefaultValuePipe, HttpCode, HttpStatus, SerializeOptions } from "@nestjs/common";
...
export class CooperatedController {
  ...
  @Roles(UserRoleEnum.admin)
  @HttpCode(HttpStatus.OK)
  update(@Param("id") id: string, @Body() updateCooperatedDto: UpdateCooperatedDto) {
